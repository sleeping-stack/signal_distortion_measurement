...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"D:/software_code/ti/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O0 -I"D:/workspace_ccs/signal_distortion_measurement/USER" -I"D:/workspace_ccs/signal_distortion_measurement" -I"D:/workspace_ccs/signal_distortion_measurement/Debug" -I"C:/ti/mspm0_sdk_2_00_01_00/source/third_party/CMSIS/Core/Include" -I"C:/ti/mspm0_sdk_2_00_01_00/source" -I"C:/ti/mspm0_sdk_2_00_01_00/source/third_party/CMSIS/DSP/Include" -gdwarf-3 -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
...
build-1245600479: ../signal_distortion_measurement.syscfg
	...
	"C:/ti/sysconfig_1.20.0/sysconfig_cli.bat" --script "D:/workspace_ccs/signal_distortion_measurement/signal_distortion_measurement.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_00_01_00/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
